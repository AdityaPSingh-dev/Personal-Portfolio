    ...
    <div className="fixed left-4 bottom-4 flex items-center justify-center overflow-hidden z-50">
      <div className="w-28 h-auto flex items-center justify-center relative md:w-14">
        ...
        <Link
          ...
          className="flex items-center justify-center absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 bg-dark w-20 h-20 rounded-full text-white hover:bg-red-500 hover:text-dark dark:bg-light dark:text-dark dark:hover:bg-red-500 dark:hover:text-light md:w-10 md:h-10 md:text-[10px] sm:text-center"
        >
          HIRE ME
        </Link>
      </div>
